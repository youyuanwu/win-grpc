...
namespace boost
{
    namespace wingrpc
    {
        ...
        {
        public:
            virtual bool HandleRequest(boost::system::error_code & ec, std::wstring const & url, std::string const & request, std::string & response) = 0;
        };
        ...
        public:
            ...
            inline bool handle_request(boost::system::error_code & ec, std::wstring const & url, std::string const & request, std::string & response)
            {
        ...
        inline void default_handler(ServiceMiddleware & middl, const winnet::http::simple_request & request, winnet::http::simple_response & response)
        {
